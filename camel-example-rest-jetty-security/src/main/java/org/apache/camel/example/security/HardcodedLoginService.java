package org.apache.camel.example.security;
...
public class HardcodedLoginService implements LoginService {
    ...
    @Override
    public UserIdentity login(String username, Object creds, ServletRequest servletRequest) {

        UserIdentity user = null;

        // HERE IS THE HARDCODING
        boolean validUser = "jhon".equals(username) && "p4ssw0rd".equals(creds);
